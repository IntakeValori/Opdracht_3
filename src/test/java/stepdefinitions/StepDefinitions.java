...
public class StepDefinitions {
    ...
    public void theContactUsFormIsAvailable(){
        ContactUsPage contactUsPage = new ContactUsPage(driver);
        assertTrue("Expecting the contact form submit button is visible", contactUsPage.isContactFormSubmitButtonVisible());
    }

    @And( "^the error message is displayed when submitting empty form$" )
    public void theErrorMessageIsDisplayedWhenSubmittingEmptyForm(){
        ContactUsPage contactUsPage = new ContactUsPage(driver);
    ...
    public void theContactFormCanBeFilledIn(){
        ContactUsPage contactUsPage = new ContactUsPage(driver);
